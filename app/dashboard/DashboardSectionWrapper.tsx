...
export default function DashboardSectionWrapper({ initialStats }: DashboardSectionWrapperProps) {
  ...
  // Client-Side Hook for auto-polling and manual refresh
  const { stats, loading, refetch } = useDashboard(initialStats);
